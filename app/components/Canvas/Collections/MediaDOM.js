...
console.log(this.element)
  ...
  animateIn() {
    ...
    // Simplify to fade in only the main container element
    this.timelineIn.fromTo(this.element, {
      autoAlpha: 0,  // GSAP's way of handling visibility and opacity together
      y: '100%'      // Optional: start the animation from below
    }, {
      autoAlpha: 1,
      duration: 1,
      ease: 'expo.out',
...
animateOut() {
    // Direct fade out without using a timeline if not required
